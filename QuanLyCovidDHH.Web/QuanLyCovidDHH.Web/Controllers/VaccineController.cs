...
using QuanLyCovidDHH.Web.Models.Vaccine;
using System;
...
namespace QuanLyCovidDHH.Web.Controllers
{
    public class VaccineController : Controller
    {
        ...
        public JsonResult DanhSach()
        {
            ...
            string url = $"{Common.Common.ApiUrl}/Vaccine";
            ...
            return Json(new { code = 200, msg = "Success", vaccine = danhsach });
        }
        ...
        public JsonResult LayTheoID(Guid ID)
        {
            ...
            string url = $"{Common.Common.ApiUrl}/Vaccine/{ID}";
            HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
            httpWebRequest.Method = "GET";
            var httpWebResponse = httpWebRequest.GetResponse();
            {
            ...
            return Json(new { code = 200, msg = "Lấy ID thành công", vaccine = BTPH });
        }
